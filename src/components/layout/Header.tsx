...
import { Plus, Package, Users, LogOut, ShoppingCart } from "lucide-react";
          ...
          <nav className="flex items-center space-x-4">
            {user ? (
              <>
                ...
                <Button variant={location.pathname === "/retirada" ? "secondary" : "default"} asChild>
                  <Link to="/retirada">
                ...
                {isAdmin() && (
                  <Button variant={location.pathname === "/usuarios" ? "secondary" : "default"} asChild>
                    <Link to="/usuarios">

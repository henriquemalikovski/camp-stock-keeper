        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-4">
            <Button 
              ...
              asChild
              className={location.pathname === "/" ? "" : "border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10"}
            >
              <Link to="/">
            ...
            <Button
              variant={location.pathname === "/cadastro" ? "secondary" : "outline"}
              asChild
              className={location.pathname === "/cadastro" ? "" : "border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10"}
            >
              <Link to="/cadastro">
